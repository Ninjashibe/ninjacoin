...
uint256 hashGenesisBlock("0x6149e523edf402191616b5ce9b39d7a9238b561d1263812dd7adfa33aa7e5b27");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Ninjacoin: starting difficulty is 1 / 2^12
...
{
    // Ninjacoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 84000); // Ninjacoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Ninjacoin: 3.5 days
static const int64 nTargetSpacing = 150; // Ninjacoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Ninjacoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Ninjacoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Ninjacoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4ea049712211c97bcb8291067ae6ce0ce2295395a7ccef591e8a2e428eb8b397");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Ninjacoin, the future!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("cef1af073c836a6418cabefdcc635281cd3be66d7607b70ac43cd4644b9d6fe57aa022e286a00f23cecee9d5ed6c25d079918c37b225c0f712d6666ebd46ac76f6") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1417641050;
        block.nBits    = 504365644;
        block.nNonce   = 872680990;

        if (fTestNet)
        {
            block.nTime    = 1417641050;
            block.nNonce   = 1549930933;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x167553b39d8308bbf2182624b5b35af6a031fe6789bc6b46a8e50835b49584de"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Ninjacoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("NinjacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("NinjacoinMiner : ProcessBlock, block not accepted");
    }
